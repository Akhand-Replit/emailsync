...
import { Mail, Users, MailOpen, ArrowRight, Inbox, Sparkles } from "lucide-react";
import { cn } from "@/lib/utils";
import { AIDigestModal } from "@/components/ai-digest-modal";
  ...
  return (
    <div className="p-8 space-y-8 max-w-7xl mx-auto animate-in fade-in-50 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            disabled={emails.filter(e => !e.flags.includes("\\Seen")).length === 0}
          >
            <Sparkles className="mr-2 h-4 w-4" /> Analyze Unread
          </Button>
        </div>
      </div>
      ...
      <AIDigestModal
        ...
        unreadEmails={emails.filter(e => !e.flags.includes("\\Seen"))}
      />
